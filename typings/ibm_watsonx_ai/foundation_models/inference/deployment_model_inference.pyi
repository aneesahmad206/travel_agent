...
class DeploymentModelInference(BaseModelInference):
    ...
    def __init__(self, *, deployment_id: str, api_client: APIClient, params: dict | TextChatParameters | TextGenParameters | None = ..., validate: bool = ..., persistent_connection: bool = ..., max_retries: int | None = ..., delay_time: float | None = ..., retry_status_codes: list[int] | None = ...) -> None:
        ...
