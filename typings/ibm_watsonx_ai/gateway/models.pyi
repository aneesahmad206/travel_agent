...
class Models(WMLResource):
    ...
    def create(self, provider_id: str, model: str, alias: str | None = ..., metadata: dict | None = ...) -> dict:
    ...
    def get_details(self, *, model_id: str | None = ..., provider_id: str | None = ...) -> dict:
    ...
    def list(self, provider_id: str | None = ...) -> pd.DataFrame:
